...
struct GEN_BANDES_12{// encapsulating global data 
	...
	int gangcols[9];// 9 bits fields for each colum (see valid band2)
	...
	uint64_t  tua2[5000], tua3[3000],// dynamic sub tables
		*ptua2,ptua3;// pointer to current table
	uint32_t  ntua2, ntua3,nua2,nua3;// , nyuas_2y;
